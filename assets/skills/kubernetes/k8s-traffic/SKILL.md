---
name: k8s-traffic
description: "Use when configuring Service, Ingress, Gateway API, or service-mesh traffic for in-cluster routing, canary, or blue/green. Apply when manifests reference networking.k8s.io or gateway.networking.k8s.io kinds."
version: 1.0.0
license: MIT
applies_when:
  files_present:
  ...
  files_contain:
    "**/*.yaml": '(networking\.k8s\.io|gateway\.networking\.k8s\.io|kind:\s*(Ingress|Gateway|HTTPRoute|VirtualService))'
  frameworks:
    - kubernetes
portability:
  level: universal
