---
name: k8s-scheduling
description: "Use when tuning pod scheduling: nodeSelector, affinity/anti-affinity, taints/tolerations, topologySpreadConstraints, priorityClass. Apply to Deployment/StatefulSet/DaemonSet manifests where placement matters for HA or noisy-neighbor isolation."
version: 1.0.0
license: MIT
applies_when:
  files_present:
    ...
    - "**/daemonset*.yaml"
  files_contain:
    "**/*.yaml": '(nodeSelector:|affinity:|tolerations:|topologySpreadConstraints:|priorityClassName:)'
  frameworks:
    - kubernetes
portability:
  level: universal
