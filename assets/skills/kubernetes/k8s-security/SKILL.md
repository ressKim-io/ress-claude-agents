---
name: k8s-security
description: "Use when hardening Kubernetes workloads with PodSecurity standards, NetworkPolicy, RBAC, securityContext, or admission controllers. Apply to manifests defining Role/RoleBinding/NetworkPolicy or pod templates with security-sensitive fields."
version: 1.0.0
license: MIT
applies_when:
  files_present:
    ...
    - "**/psp*.yaml"
  files_contain:
    "**/*.yaml": '(kind:\s*(NetworkPolicy|Role|RoleBinding|ClusterRole|ClusterRoleBinding|PodSecurityPolicy)|securityContext:|runAsNonRoot:)'
  frameworks:
    - kubernetes
portability:
  level: universal
