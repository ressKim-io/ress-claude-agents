...
description: "Use when configuring HPA, VPA, KEDA, or Cluster Autoscaler to right-size workloads under variable load. Apply when manifests use autoscaling/v2 or keda.sh, or when load-test-report shows scaling pressure."
version: 1.0.0
license: MIT
applies_when:
  files_present:
    ...
    - "**/scaledjob*.yaml"
  files_contain:
    "**/*.yaml": '(autoscaling/v2|keda\.sh/v1)'
  frameworks:
    - kubernetes
portability:
  level: universal
