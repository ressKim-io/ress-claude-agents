---
name: go-database
description: "Use when accessing databases from Go: database/sql, sqlx, sqlc, ent, gorm, pgx, jackc/pgx. Covers transaction boundaries, migration runners, connection pooling. Apply when go.mod imports a SQL driver or ORM."
version: 1.0.0
license: MIT
applies_when:
  files_present:
    ...
    - "**/go.sum"
  files_contain:
    "**/go.mod": '(database/sql|jackc/pgx|jmoiron/sqlx|sqlc-dev/sqlc|gorm\.io|entgo\.io)'
  language:
    - go
  frameworks:
    - go-modules
