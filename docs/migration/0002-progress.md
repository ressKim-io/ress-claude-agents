...
| P4. Multi-AI adapter | **next** | — | — | — | `.cursor/rules/` 자동 생성, AGENTS.md primary 승격, CLAUDE.md→symlink. 기존 `.codex/agents/*.toml` 변환 로직 흡수. P3 lock의 `adapters.status: p4-stub`을 실제 detection + view 생성으로 교체 |
